...
var max_delay_time = 2000,
    ...
    progress_bar_container_bg_color = "var(--color-point-l)",
    progress_bar_container_width = "13%",
    progress_bar_container_height = "8px",
    progress_bar_container_style = "position: absolute; top: 50%; left: 50%; width: "+progress_bar_container_width+"; height: "+progress_bar_container_height+"; background: "+progress_bar_container_bg_color+"; border-radius: 100px; transform: translate(-50%, -50%); overflow: hidden; filter: drop-shadow(0 0 5px rgba(255, 255, 255, 0.3)) drop-shadow(0 0 2px rgba(255, 255, 255));",

    progress_bar_color = "var(--color-w)",
    ...
    progress_font_size = "0px",
    progress_font_color = "#000",
    progress_font_style = "position: absolute; top: 52%; left: 50%; width: 50px; margin-left: -25px; font-family: \""+progress_font+"\"; font-size: "+progress_font_size+"; color: var(--color-w) "+progress_font_color+"; text-align: center;",
